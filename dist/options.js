...
var API_URL = "http://localhost:4000/graphql";
window.onload = function () {
  ...
  saveButton.addEventListener("click", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var username, apiKey, response, result, user;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          return fetch(API_URL, {
            ...
            body: JSON.stringify({
              query: "mutation { authenticateUser(username: \"".concat(username, "\") { id username } }")
            })
          });
        case 11:
        ...
        case 14:
          ...
          user = result.data.authenticateUser;
          if (!user) {
            _context.next = 20;
            break;
          }
  ...
  chrome.storage.sync.get(["username", "apiKey"], function (data) {
